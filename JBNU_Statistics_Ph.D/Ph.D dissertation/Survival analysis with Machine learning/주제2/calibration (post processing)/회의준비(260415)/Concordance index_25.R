...
res01 <- my.gradient.descent.U(So, X, alpha=0.01, lambda=0, time.sort2)
res01$beta.new
...
res02 <- my.gradient.descent.U(So, X, alpha=0.01, lambda=50, time.sort2)
res02$beta.new
...
res03 <- my.gradient.descent.U(So, X, alpha=0.01, lambda=100, time.sort2)
res03$beta.new
...
res04 <- my.gradient.descent.U(So, X, alpha=0.01, lambda=200, time.sort2)
res04$beta.new
...
res05 <- my.gradient.descent.U(So, X, alpha=0.05, lambda=20, time.sort2)
res05$beta.new
...
res06 <- my.gradient.descent.U(So, X, alpha=0.05, lambda=40, time.sort2)
res06$beta.new
...
res07 <- my.gradient.descent.U(So, X, alpha=0.05, lambda=80, time.sort2)
res07$beta.new
...
res08 <- my.gradient.descent.U(So, X, alpha=0.1, lambda=5, time.sort2)
res08$beta.new
...
res09 <- my.gradient.descent.U(So, X, alpha=0.1, lambda=10, time.sort2)
res09$beta.new
...
res10 <- my.gradient.descent.U(So, X, alpha=0.1, lambda=30, time.sort2)
res10$beta.new
risk.score_10 <- exp(X%*%res10$beta.new)
...
ggplot(dt2, aes(x=time, y=AUC, group=case, color=case)) +
  ...
  xlab("time") + ylab("AUC") +
  #scale_x_continuous(limits = c(3000, 4556)) +
