...
time.sort0 <- c(1.57819229353308, 5.41631197244078, 6.56052081648062,
                13.1776873461028, 15.5643633353401, 18.4842399740014,
                22.983575043227, 27.4007614817698, 32.7504667761453,
                37.3454310458217, 47.2729818928868, 57.8744052247994,
                93.7862512444224, 163.19888497778, 354.002372827381,
                539.663539035246, 556.044252565188)
...
res03 <- my.gradient.descent.U(So, X, alpha=0.01, lambda=100, time.sort0)
res03$beta.new
...
res04 <- my.gradient.descent.U(So, X, alpha=0.05, lambda=5, time.sort0)
res04$beta.new
...
res05 <- my.gradient.descent.U(So, X, alpha=0.05, lambda=20, time.sort0)
res05$beta.new
