...
res02 <- my.gradient.descent.U(So, X, alpha=0.01, lambda=0.05, time.sort0)
res02$beta.new
...
res03 <- my.gradient.descent.U(So, X, alpha=0.01, lambda=0.1, time.sort0)
res03$beta.new
...
res04 <- my.gradient.descent.U(So, X, alpha=0.01, lambda=0.5, time.sort0)
res04$beta.new
...
res05 <- my.gradient.descent.U(So, X, alpha=0.01, lambda=1, time.sort0)
res05$beta.new
...
res06 <- my.gradient.descent.U(So, X, alpha=0.01, lambda=2, time.sort0)
res06$beta.new
...
res07 <- my.gradient.descent.U(So, X, alpha=0.01, lambda=4, time.sort0)
res07$beta.new
...
res08 <- my.gradient.descent.U(So, X, alpha=0.01, lambda=8, time.sort0)
res08$beta.new
...
res02 <- my.gradient.descent.U.pair(So, X, alpha=0.001, lambda=0.05, time.sort0)
res02$beta.new
risk.score_02 <- exp(X%*%res02$beta.new)
C_Index_beta(So, res02$beta.new, X)
C_tilde_beta(So, res02$beta.new, X)
...
res03 <- my.gradient.descent.U.pair(So, X, alpha=0.001, lambda=0.1, time.sort0)
res03$beta.new
risk.score_03 <- exp(X%*%res03$beta.new)
C_Index_beta(So, res03$beta.new, X)
C_tilde_beta(So, res03$beta.new, X)
...
res04 <- my.gradient.descent.U.pair(So, X, alpha=0.001, lambda=0.5, time.sort0)
res04$beta.new
risk.score_04 <- exp(X%*%res04$beta.new)
C_Index_beta(So, res04$beta.new, X)
C_tilde_beta(So, res04$beta.new, X)
...
res05 <- my.gradient.descent.U.pair(So, X, alpha=0.001, lambda=1, time.sort0)
res05$beta.new
risk.score_05 <- exp(X%*%res05$beta.new)
C_Index_beta(So, res05$beta.new, X)
C_tilde_beta(So, res05$beta.new, X)
...
res06 <- my.gradient.descent.U.pair(So, X, alpha=0.001, lambda=2, time.sort0)
res06$beta.new
risk.score_06 <- exp(X%*%res06$beta.new)
C_Index_beta(So, res06$beta.new, X)
C_tilde_beta(So, res06$beta.new, X)
...
res07 <- my.gradient.descent.U.pair(So, X, alpha=0.001, lambda=4, time.sort0)
res07$beta.new
risk.score_07 <- exp(X%*%res07$beta.new)
C_Index_beta(So, res07$beta.new, X)
C_tilde_beta(So, res07$beta.new, X)
...
res08 <- my.gradient.descent.U.pair(So, X, alpha=0.001, lambda=8, time.sort0)
res08$beta.new
risk.score_08 <- exp(X%*%res08$beta.new)
C_Index_beta(So, res08$beta.new, X)
C_tilde_beta(So, res08$beta.new, X)
